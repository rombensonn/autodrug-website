...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    "Адрес, телефон, график работы и маршрут до автосервиса «Авто друг» в Балашихе: Заводская улица, 7А. Работаем ежедневно до 22:00.",
  path: "/kontakty"
});
      ...
      <Section>
        ...
        <div className="max-w-4xl">
          ...
          <p className="mt-5 text-lg leading-8 text-slate-700">
            Автосервис находится в Балашихе на Заводской улице, 7А. Работаем
