...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    "Услуги автосервиса «Авто друг»: шиномонтаж, диагностика, ремонт двигателя, подвески, тормозов, трансмиссии, промывка системы охлаждения и чистка форсунок в Балашихе.",
  path: "/uslugi"
});
